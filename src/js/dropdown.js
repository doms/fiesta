...
function pushPlaylist(file, meta) {
	...
	audio.addEventListener('loadedmetadata', function() {
	    ...
	    playlist.push({
			...
			dom: $('#track-list').append($('<tr class="track" data-track="' + playlistX + '"><td class="playing-arrow"><img width="15" src="images/bars.svg" /></td><td>' + cutTrackName + '</td><td class="track-length">' + trackDuration + '</td></tr>').click(playSelectedTrack))
		})
